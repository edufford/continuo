...
actual time: 0.404 s (74x real-time), world hash 152db7f40041f053
```
...
period) that reads the car's pose and publishes the yaw rate to hold, and a
...
Steering and acceleration arrive as separate messages, and the physics holds
